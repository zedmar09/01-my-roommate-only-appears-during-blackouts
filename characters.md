...
`My Roommate Only Appears During Blackouts` is a modern supernatural romantic comedy with adult leads, a mystery plot, and urban-fantasy electricity rules. Its visual language should be distinct from every existing story in the library.

- Different from `Blood Ledger`: no corporate revenge protagonist, no debt ledgers, no audit-room noir identity, no ash-brown cropped hair plus mole combination, and no chaebol-war staging.
- Different from `My Girlfriend's Loyalty Is Only 5%`: no floating loyalty percentages, no accident-scar round-glasses male lead, no transparent-umbrella mystery woman, and no romance built around numerical paranoia.
- Different from `The Villainess Who Married The Ghost King`: no imperial robes, phoenix ornaments, palace wedding iconography, royal curse visuals, or xianxia half-mask styling.
- Different from `The Villain's Second Funeral`: no gothic coffin imagery, mourning cloak, aristocratic warlord silhouette, or regression revenge tone.
- Different from `Lanterns of the Last Station`: no hidden platforms, paper lanterns, ticket rules, red scarf identifier, or teenage station-uniform mystery.
- Different from `The Cartographer of Unsaid Things`: no emotion-born streets, coastal fantasy maps, courier satchels, moonlit canals, or elegant cartographer silhouettes.

Visual world: present-day Seoul, a smart high-rise apartment, game studio workstations, elevator cameras, rooftop utility spaces, breaker rooms, late-night convenience stores, rain on balcony glass, power outage candles, notification banners, firmware update screens, and the eerie flat light of electronics that should be dead.
...
- Role: Main protagonist; overworked game designer and new tenant of Unit 2407.
- Age: 30.
...
- Role: Male lead; mysterious masked roommate; former electrical-grid engineer erased into the city's power network.
- Common Address: Hyun-woo.
- Age: Appears 32-35. Official age and records are missing.
- Occupation: Former electrical-grid engineer investigating unexplained failures across Seoul.
...
- Consistency Notes: Hyun-woo should not read as a palace half-mask prince, vampire, warlord, school delinquent, or corporate avenger. He is a modern urban-fantasy figure: half engineer, half haunted circuit, all unwilling roommate.

### The Black Surge

- Role: Main supernatural threat; intelligent electrical entity living inside Hyun-woo and spreading through connected devices.
- Nature: A self-organizing current born or awakened during an experimental power-network accident.
- Personality: Patient, invasive, curious about human attachment, jealous of memories it cannot consume, speaks in borrowed notification language and broken familiar voices.
- Visual Language: Dead screens turning on without power, black pixels crawling across matte dark screens, waveform mouths on smart speakers, camera feeds one second out of sync, fingerprints made of static, and pale current marks that mimic Hyun-woo's tattoos but move incorrectly.
- Feeding Method: Consumes memory traces from devices and people. It begins with digital records, then eats the emotional memory attached to those records.
- Story Function: Uses Hyun-woo as a host, isolates him by erasing proof of his life, and pressures Nari to choose between saving Hyun-woo's body and keeping her memories of him.
- Consistency Notes: The entity is not a ghost, demon, god, or ordinary program. Treat it as a living electrical hunger that learned personality by passing through human devices.

### Na Young-sook

- Role: Landlord and building owner who gives Nari the midnight warning.
- Age: Late 60s.
- Occupation: Owner of several high-rise rental units, including Unit 2407.
- Personality: Polite, evasive, superstitious in a way that feels too informed, financially sharp, guilt-ridden beneath her brisk manners.
- Visual Design: Older Korean woman with silver hair in a tight twist, square jade earrings, a tailored mauve coat, neat gloves, and an old analog wristwatch she checks whenever lights flicker.
- Strongest Identifiers: Jade earrings, analog watch, key ring with physical metal keys despite the building's smart locks.
- Story Function: Knows more about Unit 2407 than she admits. Her warning suggests previous tenants have been harmed or erased.
- Consistency Notes: She should feel like a practical older woman protecting herself through rules, not a witch archetype.

### Koo Hyejin

- Role: Nari's closest friend and coworker; QA lead who notices patterns others dismiss.
- Age: 31.
...
- Role: Building maintenance chief who understands the old wiring beneath the smart renovations.
- Age: 54.
- Occupation: Maintenance chief for the high-rise.
- Personality: Gruff, observant, superstitious about elevators, hates the smart-home system, quietly kind to tenants who treat staff respectfully.
- Visual Design: Stocky Korean man with a shaved head, heavy work jacket, tool belt, old flashlight, and a paper notebook of maintenance logs.
- Strongest Identifiers: Old flashlight, paper logbook, electrical tape wrapped around two fingers, distrust of touchscreens.
- Story Function: Helps Nari uncover that Unit 2407's wiring predates the building renovation and was modified after Hyun-woo's accident.

## Important Locations

### Unit 2407

- A modern smart apartment with automated lights, a voice assistant, door cameras, thermostat controls, smart refrigerator, robot vacuum, hidden breaker panels, and a wiring closet that does not appear on the official floor plan.
- In normal power, the unit feels matte modern, cold, and too convenient.
- During blackouts, it becomes warm and intimate: candles, city silence, manual locks, open windows, and Hyun-woo's physical presence.

### The Rooftop Service Deck

- Windy rooftop space above the high-rise with telecom boxes, maintenance rails, warning lights, and a view of Seoul's power grid stretching across the city.
- Hyun-woo can remain near-human there during rolling outages if the building generator is unstable.
- Nari and Hyun-woo use it for private conversations because the apartment devices listen too easily.

### Nth Pixel Studio

- Nari's workplace: a crowded mobile game studio with cluttered desks, build monitors, office snacks, bug boards, overnight sleeping bags, and staff who communicate half in jokes and half in crisis.
- Provides modern work pressure and game-design metaphors for Nari's investigation.

### The Experimental Grid Site

- Former underground power-network test facility connected to a city infrastructure project.
- Hyun-woo was erased there during an unexplained accident.
- Official maps rename, omit, or mislabel the site whenever Nari tries to search it.
...
- Hyun-woo and the entity may use the same device, but their visual signatures must never be identical: clean cyan-white text for Hyun-woo, corrupted white status text with crawling black pixels for the entity.
- Hyun-woo's jealousy should be funny before it becomes frightening. Draining a flirt's phone is comedy. Locking every exit is not.
- The romance builds through shared routines: noodles, candles, fixing breakers, sleeping near the door during storms, leaving notes on paper, and trusting touch only when the lights are gone.
- The central tragedy is memory cost. Hyun-woo wants a life, but the proof of that life exists most strongly inside Nari.
