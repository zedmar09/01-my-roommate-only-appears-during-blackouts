...
| Strip | Read beats | Source | Main purpose | Seam OUT |
|---:|---|---|---|---|
| 001 | V01–V07 | P1 | complete move-in / smart-home / speaker welcome | G |
| 002 | V08–V11 | P2 | Mrs. Na arrives / binder-key setup | G |
...
| 008 | V36–V40 | P5 | paper test / pen movement | G |
| 009 | V41–V45 | P5–P6 | reply / photos / tablet freeze | A/E |
| 010 | V46–V50 | P6 | paper-only warning / binder / Mrs. Na texts | G |
| 011 | V51–V54 | P7 | blackout kit / apartment prep | G |
| 012 | V55–V59 | P8 | Seungjae arrival / phone dies | A |
...
| 022 | V98–V102 | P14 | candle order / `IDENTITY LOCKING` / blue-center warning | A/E |
| 023 | V103–V107 | P14 | candle out / shriek / knife drop / wrist catch | G |
| 024 | V108–V112 | P15 | separate hostile actor / broken-message explanation | G/E |
| 025 | V113–V118 | P15 | city return / Unit power return / Hyun-woo absent | G |
| 026 | V119–V123 | P16 | locked-door / history / camera / security evidence | G |
| 027 | V124–V127 | P16 | Mrs. Na voicemail / cabinet chimes | A/G |
| 028 | V128–V132 | P17 | cabinet/speaker reveal / borrowed power / knife retrieval | A |
| 029 | V133–V137 | P17 | sheathe knife / inspect food / paper + south-wall warning | G |
| 030 | V138–V142 | P18 | missing-section silence / danger question / notebook route | G |
