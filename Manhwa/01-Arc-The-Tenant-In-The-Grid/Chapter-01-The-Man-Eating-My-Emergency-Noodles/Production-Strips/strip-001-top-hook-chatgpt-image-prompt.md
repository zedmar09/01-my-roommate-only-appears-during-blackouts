# Strip 001 — Move-In / Smart Home Welcome

```text
Create exactly ONE tall full-color 2D manhwa TECHNICAL STRIP for Chapter 1 of "My Roommate Only Appears During Blackouts".

THIS IS NOT A PAGE. Never draw page numbers, circled panel numbers, strip IDs, beat IDs, headers, footers, crop guides, or reader-visible production labels.

PRODUCTION SCOPE
Internal beats V01–V07. These IDs are production-only and must never appear in the artwork.
