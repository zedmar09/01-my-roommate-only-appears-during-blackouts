# Strip 020 — Mrs. Na / Hostile Start / Chair Rise — FINAL DETERMINISTIC GENERATION PROMPT

```text
Create exactly ONE tall full-color 2D manhwa TECHNICAL STRIP continuing the SAME blackout scene from the APPROVED rendered Strip 019.

THIS IS NOT A PAGE. Never render V90–V93, Strip 020, temporary-state labels, filenames, QA notes, or production metadata.
...
10. APPROVED rendered Strip 019 image
...
==================================================
Nari remains wary/controlled. Hyun-woo remains calm/dry until V92 causes focused protective urgency. His taller/broader relation becomes visible through real standing mechanics, never camera enlargement.

Approximate height:
V90 16% | V91 18% | V92 24% | V93 42% — LARGEST.

==================================================
V90 — WHO ELSE KNOWS? — FULL BLUEPRINT
==================================================
CAMERA: same interrogation axis and exact positions.
NARI:
...
==================================================
V92 — HOSTILE REFRIGERATOR START / HYUN-WOO STILL SEATED — FULL BLUEPRINT
==================================================
CAMERA: refrigerator/dining composition using canonical fridge detail.

EVENT:
- SAME candle flame bends; holder stays fixed
...
==================================================
V93 — REAL CHAIR PUSH / RISE — FULL BLUEPRINT
==================================================
...
RELATIVE SCALE:
- do NOT enlarge Hyun-woo in upper body
- do NOT shrink Nari/chair
- canonical tall/broad relation becomes clear because he physically stands
