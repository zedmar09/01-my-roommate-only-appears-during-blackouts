...
- subtle indicator hardware
- no brand/logo/text printed on body

STATE VARIANTS:
A. neutral powered/off-voice state
B. ordinary assistant activation with restrained `BLIP` indicator behavior
C. clean helpful/Hyun-woo communication state — weak stable cyan-white hardware accent, no hostile black pixels
D. visibly unplugged state with disconnected cord
E. stored in the canonical stockpot under two dish towels
