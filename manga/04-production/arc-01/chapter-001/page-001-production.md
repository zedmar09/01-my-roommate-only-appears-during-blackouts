...
The exact minute is not reader-critical, but the page should visually communicate that it is clearly after midnight.
...
**Size:** wide dominant upper panel.

**Camera:** medium-wide establishing view from a slightly elevated natural eye-level perspective, not cinematic.

**Environment anchors:**

- use the exact approved workplace geometry
...
- dark night visible through office windows if present in the atlas
...
**Do not show:** supernatural effects, dramatic shadows, horror framing, unknown figure.

### Panel 2 — Coworker Checks On Nari

**Narrative beat:** ordinary social proof that Nari is still at work late.

**Size:** smaller middle-right panel.

**Camera:** medium shot of one unnamed coworker near the edge of Nari's desk zone, bag/coat ready to leave.
...
**Balloon:** normal conversational balloon, compact, placed for right-to-left reading without covering faces or important environment anchors.

### Panel 3 — Nari Answers While Working

**Narrative beat:** characterize Nari through dry work focus.

**Size:** larger middle-left panel.

**Camera:** medium-close 3/4 view of Nari at her desk.
...
**Reference priority:** Nari face/hair/hand identity must come from `nari-canonical.webp`, not from generic Style B woman.

### Panel 4 — Location / Time Proof

**Narrative beat:** end the page by visually confirming Nari remains in the office after midnight.

**Size:** full-width lower panel with breathing room.

**Camera:** medium-wide angle using the approved Nari desk/workplace geometry, preferably a different but consistent angle from Panel 1.
...
- selective screentone and hatching
- controlled solid blacks
- substantial clean white areas
- adult anatomy
- readable hands
- detailed workplace background in establishing panels
- simpler background focus acceptable in Panel 3
- no color
- no glossy webtoon rendering
- no photorealism
- no CGI/3D
...
Keep the page grounded, adult, mundane and slightly tired. Do not introduce suspense lighting, apartment imagery, supernatural effects, silhouettes, blackouts, ghost imagery, foreshadowing symbols or additional mystery dialogue. The purpose is to establish Nari's normal life and prove she is physically away from home.

Use finished published-manga ink quality, varied line weight, selective screentone/hatching and clean readable gutters. Preserve right-to-left reading order. Do not invent logos, company names, manuscript text, captions, labels or extra dialogue.
...
- page does not contain exactly 4 panels
...
- any apartment or supernatural imagery appears
- lighting/composition becomes ominous/horror-coded
- color/glossy/painterly/photoreal/CGI/cinematic rendering appears
...
- [ ] Style A/B rendering language matched
