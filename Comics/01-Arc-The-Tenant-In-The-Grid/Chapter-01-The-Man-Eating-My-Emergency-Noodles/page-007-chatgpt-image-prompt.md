# Page 007 ChatGPT Image Prompt

Copy the prompt below into ChatGPT to generate Chapter 1, Page 7 as PNG. Save it as `7.png`, then manually convert it to `7.webp`.
...
Stop after this one page. Do not generate Page 8.
...
Use 100% flat 2D human-drawn manga/manhwa artwork with clean ink, matte cel colors, solid blocking, adult proportions, and one hard-edged shadow. Apply to Nari, store, bags, supplies, apartment, furniture, appliances, knives, trays, and backgrounds. No glossy/cinematic/photoreal/3D/CG/painterly/airbrushed/reflective/bloom/rim-light/flare/volumetric/gradient/blur/glare/wet/shiny/over-rendered effects.
