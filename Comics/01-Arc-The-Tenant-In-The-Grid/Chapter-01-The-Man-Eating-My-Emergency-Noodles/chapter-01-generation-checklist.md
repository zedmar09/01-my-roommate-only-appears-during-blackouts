...
- Attach the most recent approved page as visual reference, but never use front/back support banners or symbolic story cover as interior continuity references.
...
- shiny skin, shiny lips, glossy hair, plastic shine, or chrome-like shine
- reflective floor, reflective window, mirror-like appliance, refrigerator glare, television glare, glass glare, or white reflection streak
- bloom, rim light, lens flare, volumetric beam, neon aura, excessive glow, or atmospheric glow flooding the room
- strong gradients, depth-of-field blur, over-rendered texture, or wet-looking surface

Required appearance: 100% flat 2D human-drawn modern manga/manhwa, clean visible ink, matte cel colors, solid color blocking, controlled hard-edged shading, mature adults, readable environments.
...
For each page, approve only after checking:

- panel order and text accuracy
- character face/body/wardrobe continuity
- power and device-actor rules
- environment/appliance geometry
- object scale, position, state, and hand use
- brightness/style against previous approved page
- no spoiler or invented flashback
