# Page 011 ChatGPT Image Prompt

Copy the prompt below into ChatGPT to generate Chapter 1, Page 11 as PNG. Save it as `11.png`, then manually convert it to `11.webp`.
...
100% flat 2D human-drawn manga/manhwa: clean ink, matte cel colors, solid blocks, mature adults, one hard-edged shadow. Apply to skin, hair, mask, tattoos, clothes, knife, candle, holder, pot, table, appliances, and background. No glossy/cinematic/photoreal/3D/CG/painterly/airbrushed/reflective/bloom/rim-light/flare/volumetric/gradient/blur/glare/wet/shiny/over-rendered treatment.

ENVIRONMENT AND APPLIANCE MASTER LOCK
Fixed kitchen/dining geometry. Candle in ceramic holder and noodle pot on trivet stay on table. Pantry remains ajar; cooktop remains off after use. No object moves except scripted hands/chopsticks/mask.

LIGHTING AND EXPOSURE LOCK
Readable charcoal/blue-gray blackout blocks with small local matte amber candlelight. Faint tattoo accents do not light the room.
...
Hyun-woo is tall but human-scale; chair/table/pot/candle/knife remain residential scale. Mask is fitted, not a fantasy half-mask.

CONTINUITY
His first line answers Nari's `I AM ARMED`; his name answers her direct question.

TIME AND SCENE CONTINUITY
Exact continuation at 12:56 A.M. No time jump or flashback.

TIME TRANSITION CARD
NO TIME CARD. This page directly continues Page 10.

SPOILER BOUNDARY
Reveal appearance/name only. No origin, Black Surge name, accident, or future rules.

PAGE FORMAT AND PACING
One vertical page with 4 large panels; let the first physical reveal breathe.

PANEL ORDER NUMBERS
Add small circled numbers 1-4, never over text/faces/hands/tattoos/props.

PAGE LAYOUT AND SCRIPT
PANEL 1 - Nari remains at entrance, knife held low; seated figure hidden across table.
HYUN-WOO: WITH THE FRUIT KNIFE OR THE BIGGER ONE?

PANEL 2 - Nari tightens grip, fear turning into offended focus.
...
Only quiet mask sound; no electrical spectacle.

TEXT AND LETTERING RULES
Use exact uppercase dialogue in clean bubbles. No screen text, extra narration, or labels.
