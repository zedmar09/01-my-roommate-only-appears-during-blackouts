...
Stop after this one page. Do not generate Page 12.

IMPORTANT REFERENCES
Use `../../../characters.md` and `../../style-guide.md`; directly continue approved Page 10 and match its exact character/object positions.
...
3. this current `page-011-chatgpt-image-prompt.md`
4. the approved Page 10 image as mandatory position/environment continuity reference

For a targeted correction of an otherwise correct Page 11, use the current near-pass Page 11 image as the edit target together with this `.md`; preserve all correct panels/text/characters and change only the explicitly identified defects.

Never use an older rejected Page 11, the legacy cover, or an unrelated page as continuity authority.
