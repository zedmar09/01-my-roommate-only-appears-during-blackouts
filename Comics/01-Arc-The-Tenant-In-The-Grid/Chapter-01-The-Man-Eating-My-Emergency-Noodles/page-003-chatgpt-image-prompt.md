# Page 003 ChatGPT Image Prompt

Copy the prompt below into ChatGPT to generate Chapter 1, Page 3 as PNG. Save it as `3.png`, then manually convert it to `3.webp`.

```text
Create a colored flat 2D human-drawn modern supernatural romance manga/manhwa comic page for Chapter 1, Page 3 of "My Roommate Only Appears During Blackouts".

IMPORTANT REFERENCES
Use `../../../characters.md` and `../../style-guide.md`; preserve prior Nari and apartment designs.
...
Use 100% flat 2D human-drawn manga/manhwa artwork with clean ink linework, matte cel colors, solid blocks, adult proportions, expressive comedy, and one hard-edged shadow tone on every surface. No glossy, cinematic, photoreal, 3D/CG, painterly, airbrushed, reflective, bloom, rim-light, flare, volumetric, gradient, blur, glass-glare, wet, shiny, or over-rendered effects anywhere.

ENVIRONMENT AND APPLIANCE MASTER LOCK
Keep Unit 2407 geometry/palette fixed. Speaker is a small screenless matte-charcoal cylinder on the pale-gray kitchen counter, cord visibly connected to a wall outlet. Thermostat, robot vacuum, curtains, and all appliances remain realistically sized, matte, and in stable positions.
...
Nari is the same 30-year-old Korean game designer; at home she wears an oversized hoodie and loose black trousers, yellow scrunchie visible, headphones nearby/around neck, beauty mark preserved.

SETTING AND PROP CONTINUITY
One week after move-in. Binder remains on kitchen counter and brass key remains in entry tray. At night Nari holds cup noodles and chopsticks; chopsticks land on the floor when startled. Speaker begins plugged in and ends unplugged on the counter.
