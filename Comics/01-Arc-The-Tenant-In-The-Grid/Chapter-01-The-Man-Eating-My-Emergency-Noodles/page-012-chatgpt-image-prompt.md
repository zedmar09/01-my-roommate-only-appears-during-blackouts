...
100% flat 2D human-drawn manga/manhwa with clean ink, matte cel colors, solid blocks, adult proportions, one hard-edged shadow. No glossy/cinematic/photoreal/3D/CG/painterly/airbrushed/reflective/bloom/rim-light/flare/volumetric/gradient/blur/glare/wet/shiny/over-rendered treatment.

ENVIRONMENT AND APPLIANCE MASTER LOCK
Fixed table center, pantry/refrigerator right, cooktop behind. Candle holder, pot/trivet/cloth, five remaining packets, pushed/unchanged chair, and all appliances keep state.

LIGHTING AND EXPOSURE LOCK
Readable flat blackout palette with small local matte amber candle. No glow flooding or reflective appliance surfaces.
...
Packet is foot-sized packaging, not giant. Show Nari's route from entrance toward table. Preserve chair positions.

CONTINUITY
Noodle inventory must be exact: the last spicy-seafood flavor is gone, but five other packets remain.

TIME AND SCENE CONTINUITY
Direct continuation; conversation progresses line by line with replies visibly answering prior lines.

TIME TRANSITION CARD
NO TIME CARD. Direct continuation.

SPOILER BOUNDARY
Hyun-woo names Mrs. Na but gives no origin or full rule explanation.

PAGE FORMAT AND PACING
One vertical page with 6 panels, balancing comedy and guarded mystery.

PANEL ORDER NUMBERS
Add small circled numbers 1-6, never over dialogue/faces/hands/packet/knife.

PAGE LAYOUT AND SCRIPT
PANEL 1 - Nari takes one cautious step; bare foot nudges empty spicy-seafood packet. Five other packets visible in pantry.
SFX: CRINKLE.
NARI: YOU ATE MY LAST SPICY SEAFOOD ONE?

PANEL 2 - Hyun-woo glances toward pantry, mildly defensive.
HYUN-WOO: YOU STILL HAVE FIVE.

PANEL 3 - Nari looks offended; knife stays low.
NARI: FIVE INFERIOR ONES. YOU ARE HAUNTING MY NOODLES.

PANEL 4 - Dry Hyun-woo gestures toward pot.
HYUN-WOO: I AM NOT HAUNTING THEM. I AM EATING THEM.

PANEL 5 - Nari demands the practical answer; he replies.
NARI: HOW DID YOU GET IN?
HYUN-WOO: I LIVE HERE.

PANEL 6 - Nari rejects it; Hyun-woo names landlord, becoming guarded.
NARI: I SIGNED THE LEASE ALONE.
HYUN-WOO: MRS. NA SHOULD HAVE WARNED YOU.
NARI: YOU KNOW MRS. NA?

SFX AND TEXT BLENDING
Use only packet crinkle, small and physical.

TEXT AND LETTERING RULES
Use exact uppercase dialogue and clear top-to-bottom bubble order. No extra jokes or exposition.
