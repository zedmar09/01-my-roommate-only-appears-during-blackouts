...
Copy the prompt below into ChatGPT to generate Chapter 2, Page 18 as PNG. Save as `18.png`, then convert to `18.webp`.

```text
Create exactly ONE vertical colored flat-2D human-drawn manga/manhwa page for Chapter 2, Page 18 of "My Roommate Only Appears During Blackouts".

IMAGE-ONLY EXECUTION LOCK
FINAL prompt; execute literally; image only; stop after Chapter 2 Page 18.
...
SPOILER BOUNDARY
Do not open panel, show what is behind it, identify hostile entity, reveal accident/origin, or explain connection.
...
PANEL 3 — Hyun-woo immediately warns through unplugged speaker in open lower cabinet.
HYUN-WOO: DON'T.

PANEL 4 — Nari keeps both hands on table, does not move toward panel.
NARI: I DIDN'T MOVE.
...
`TIK` and `TIK... TIK...` must source-align to closed south-wall panel, not lamp, refrigerator, cabinet, or speaker.
...
|---|---|---|
| 1 SFX | Behind closed south-wall panel | `TIK` |
| 3 Hyun-woo | Voice through unplugged speaker | `DON'T.` |
| 4 Nari | Spoken | `I DIDN'T MOVE.` |
| 5 SFX | Behind closed south-wall panel | `TIK... TIK...` |

## Required Panel Order Markers
`1` through `6`.

## Production Thread Use
Attach Nari canonical PNG, this prompt, approved Page 17. Hyun-woo remains voice-only. Do not generate Chapter 3 from this prompt.
