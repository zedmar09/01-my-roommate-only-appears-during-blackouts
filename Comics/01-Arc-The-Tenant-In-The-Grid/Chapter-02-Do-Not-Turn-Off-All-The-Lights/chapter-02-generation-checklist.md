...
Important asset precondition: **before generating Page 8, create and QA-approve `Character-References/hyejin-canonical-flat2d.png` from `Character-References/hyejin-canonical-flat2d-chatgpt-image-prompt.md`.** Page 8 is blocked until that canonical PNG exists.
...
- Reproduce all dialogue, narration, SFX, device text, and notebook text verbatim.
- Preserve capitalization, punctuation, line order, source/speaker, panel assignment, and text type.
...
## Approved Artwork Visual Authority — ABSOLUTE

For the Chapter 1 → Chapter 2 handoff, the APPROVED Chapter 1 Page 18 ARTWORK is the visual authority for every subject, table item, prop, furniture/appliance relationship, clothing state, and lighting condition visible to the reader.

If an older textual prompt, generic layout note, or remembered left/right screen placement conflicts with what is visibly shown in the approved artwork, the approved artwork wins for the visible handoff state. Written ledgers may only fill in off-frame objects; they may not contradict or redesign the approved image.

For Page 1 generation, attach the APPROVED Chapter 1 Page 18 artwork. Do not rely on text-only memory of the scene.
...
| Page | Visible required canonical reference(s) |
|---:|---|
| 1–2 | Nari canonical PNG |
| 3–7 | Nari + Mrs. Na canonical PNGs |
| 8–9 | Nari + Hyejin canonical PNGs |
| 10–18 | Nari canonical PNG only; Hyun-woo voice-only |
...
Page 1 must attach the APPROVED Chapter 1 Page 18 ARTWORK and preserve the exact visible physical state.

Verify all of the following at Chapter 2 Page 1 start:

- Unit 2407 fully powered and normally lit.
- Nari seated at same dining-table position in same Chapter 1 ending home/blackout outfit and established indoor/barefoot state.
- large noodle pot still on the same dining-table trivet/hot plate.
- ceramic mug still on the dining table in its approved position.
- visible blue dining-table towel/folded cloth still in its approved position.
- physical notebook remains part of the same dining-table work area.
- lower cabinet open.
- same speaker-storage stockpot/towels/lid/unplugged speaker arrangement; disconnected cord when visible.
- phone/binder retain established kitchen-counter state when framed.
- brass backup key remains entry tray.
- pantry inventory remains exactly five unopened noodle packets.
- TV visibly unplugged and already showing `NEW TENANT CONFIRMED`.
- Hyun-woo physically absent / voice-only.

Do not force an old generic screen-side layout if the approved artwork uses a different camera angle. Preserve actual room relationships.

### Direct-continuation cleanup prohibition
Pages 1–2 are the same uninterrupted late-night scene. **No visible dinner/environment anchor may silently clean itself up or move during Pages 1–2.** Page 1 changes only the hostile TV display. Page 2 Panel 6 may close only the lower speaker cabinet as scripted.

Automatic reject on Pages 1–2 if any of these occur without a scripted move:
- noodle pot disappears
- ceramic mug disappears
- blue table towel/cloth disappears
- table becomes clean/minimalist
- open cabinet closes early
- TV is relocated/redesigned
...
- noodle pot/trivet may be put away.
- ceramic mug may be put away.
- blue dining-table towel/cloth may be put away.
- empty packet/wrapper and candle/holder may be put away.
...
- off-frame safety/evidence props retain their last established states unless later explicitly moved.
...
- Pages 3–7: same canonical Nari/home continuity; overnight cut does not authorize random redesign.
...
- APPROVED Chapter 1 Page 18 artwork controls visible environment/object state.
- P1 preserves seated Nari + large noodle pot + ceramic mug + blue table towel/cloth + open cabinet + already-active TV.
...
- No other visible handoff anchor silently moves/cleans/resets.
