...
Copy the prompt below into ChatGPT to generate Chapter 2, Page 6 as PNG. Save as `6.png`, then convert to `6.webp`.

```text
Create exactly ONE vertical colored flat-2D human-drawn manga/manhwa page for Chapter 2, Page 6 of "My Roommate Only Appears During Blackouts".

IMAGE-ONLY EXECUTION LOCK
FINAL production prompt. Execute literally, image only. No rewriting/reblocking/invention.

READER-FACING TEXT LOCK — ABSOLUTE
All eight dialogue lines are verbatim/source/panel locked.

IMPORTANT REFERENCES
Use `../../../characters.md`, `../../style-guide.md`, approved Page 5.
...
PANEL 1 — Nari glances toward steadily powered hallway lamp, then Mrs. Na.
NARI: IS THAT LIGHT WHAT MAKES HIM APPEAR?
...
NARI: THEN WHY DOES THIS HAVE TO STAY ON?

PANEL 5 — Mrs. Na becomes guarded again.
MRS. NA: BECAUSE THE LIGHT IS FOR SOMETHING ELSE.

PANEL 6 — Nari connects it to corrupted screen incidents.
NARI: THE THING IN THE SCREENS.

PANEL 7 — Mrs. Na refuses direct confirmation and repeats practical rule. Lamp stays steadily on.
MRS. NA: KEEP ONE MAINS-POWERED LIGHT ON AFTER MIDNIGHT.
...
| 6 Nari | Spoken | `THE THING IN THE SCREENS.` |
| 7 Mrs. Na | Spoken | `KEEP ONE MAINS-POWERED LIGHT ON AFTER MIDNIGHT.` |

## Required Panel Order Markers
`1` through `7`.

## Production Thread Use
Attach Nari + Mrs. Na canonical PNGs, this prompt, approved Page 5.
