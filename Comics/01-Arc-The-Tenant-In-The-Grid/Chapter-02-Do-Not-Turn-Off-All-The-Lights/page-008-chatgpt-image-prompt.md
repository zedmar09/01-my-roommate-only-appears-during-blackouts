...
Copy the prompt below into ChatGPT to generate Chapter 2, Page 8 as PNG. Save as `8.png`, then convert to `8.webp`.

```text
Create exactly ONE vertical colored flat-2D human-drawn manga/manhwa page for Chapter 2, Page 8 of "My Roommate Only Appears During Blackouts".

IMAGE-ONLY EXECUTION LOCK
FINAL prompt. Execute literally; image only; no rewrite or invented text.
