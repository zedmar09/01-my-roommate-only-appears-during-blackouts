# Front KISAH Support Banner ChatGPT Image Prompt

Copy and paste the prompt below into ChatGPT to generate the reusable compact front support banner. Ask ChatGPT to return the artwork itself as an exact 1024 x 768 landscape PNG. After approval, save the PNG as `front.png`, then manually convert it to `front.webp`. Use this banner before each chapter unless a chapter needs a custom promotion.
...
Create a compact colored flat 2D human-drawn FRONT SUPPORT BANNER for KISAH readers.
...
Use one consistent medium-bright neutral flat-color exposure across the entire banner. Keep the cool-gray wall, eucalyptus accent, neutral-gray floor, refrigerator edges, doors, handles, and display clearly readable. Use at most one hard-edged cel-shadow tone per surface. No gradients, rim light, halos, volumetric beams, lens flare, bloom, color grading, airbrushed shading, specular highlights, white reflection streaks, dark cinematic exposure, blown-out whites, glossy appliance surfaces, reflective floors, or depth-of-field blur.

CHARACTER AND PROP CONTINUITY
Do not show characters, people, faces, hands, bodies, or human silhouettes. Use one appliance only: the Unit 2407 smart refrigerator. It is a normal 180 cm-tall matte cool-gray refrigerator with two upper doors, one lower freezer drawer, recessed dark handles, and one narrow black rectangular display on the upper-right door. Keep it realistically proportioned and consistent with the chapter pages. No chrome trim, glossy reflections, or redesign.
